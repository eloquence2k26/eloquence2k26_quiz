    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-50/80 dark:bg-black transition-colors duration-200">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-zinc-400 font-normal">Select your portal type below to continue</p>
        </div>
        ...
        <div className="basic-card p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase text-slate-500 dark:text-zinc-400 tracking-wider block">
              Choose Login Type
            </label>
          ...
          <div className="p-3.5 rounded-2xl bg-slate-100/70 dark:bg-zinc-900/70 border border-slate-200 dark:border-zinc-800 flex items-center gap-3">
            {activeRole === 'admin' ? (
              <>
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Admin Portal</h4>
                  <p className="text-[11px] text-slate-500 dark:text-zinc-400">Manage questions, users, and live quiz settings</p>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Participant Portal</h4>
                  <p className="text-[11px] text-slate-500 dark:text-zinc-400">Take quizzes, attempt rounds, and view your score</p>
                </div>
              </>
            )}
          </div>
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-zinc-800 space-y-3 text-center">
            <p className="text-[11px] text-slate-500 dark:text-zinc-400 font-semibold uppercase tracking-wider">
