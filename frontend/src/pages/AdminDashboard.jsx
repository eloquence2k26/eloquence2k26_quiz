    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-8 space-y-8">
      ...
      <section className="glass-panel-light rounded-3xl p-6 sm:p-10 shadow-xl space-y-6 transition-colors duration-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900/60 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800">
            <span className="text-xs text-zinc-500 dark:text-zinc-400 block font-medium">Attempts Recorded</span>
            <span className="text-2xl font-black text-zinc-900 dark:text-zinc-100">289</span>
          </div>
          <div className="bg-zinc-50 dark:bg-zinc-900/60 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800">
            <span className="text-xs text-zinc-500 dark:text-zinc-400 block font-medium">Database Status</span>
            <span className="text-xs font-bold text-zinc-900 dark:text-zinc-100 flex items-center gap-1 mt-2">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-panel-light rounded-2xl p-6 space-y-4">
          ...
          <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Quiz Question Editor</h3>
        ...
        <div className="glass-panel-light rounded-2xl p-6 space-y-4">
          ...
          <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Export Results & CSV</h3>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
